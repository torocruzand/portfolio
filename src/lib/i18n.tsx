...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "project8.description": "A mobile application presenting the enriched and contextualized content of the writer Ramiro Valdés Galarraga. Built for Android using LiveCode.",
  ...
  es: {
    ...
    "project8.description": "Una aplicación móvil que presenta el contenido enriquecido y contextualizado del escritor Ramiro Valdés Galarraga. Construida para Android usando LiveCode.",
  ...
  pt: {
    ...
    "project8.description": "Uma aplicação móvel que apresenta o conteúdo enriquecido e contextualizado do escritor Ramiro Valdés Galarraga. Construída para Android usando LiveCode.",
